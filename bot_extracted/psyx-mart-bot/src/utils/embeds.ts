...
export const COLORS = {
  ...
  vouch:      0x00E5CC as ColorResolvable, // Vouch teal
  sell:       0xFF8C00 as ColorResolvable, // Orange for sell
};

export const BOT_OWNER_ID_DISPLAY = '812192341179236382';
export const BOT_FOOTER = { text: `✦ PSYX MART Bot • Owner: ogpsyx` };
